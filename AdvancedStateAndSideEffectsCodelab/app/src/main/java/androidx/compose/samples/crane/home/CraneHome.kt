...
fun CraneHome(
    ...
    Scaffold(
        ...
        // 컴포지션 외부인, 일반 콜백 내부에서 코루틴을 만들기 위해서는 rememberCoroutineScope를 사용한다
...
fun CraneHomeContent(
    ...
    // collectAsState : Compose 의 State API를 통해 StateFlow 의 최신 값을 나타낸다.
    // StateFlow의 값이 변할 때 마다 재구성 된다.
